  ...
  <div class="col-md-4">
	...
	<div id="myModal" class="modal fade"  role="dialog">
	  <div class="modal-dialog">
        ...
        <c:if test="${requestScope.falschesPass}">
	...
	<div id="myModalReg" class="modal fade" role="dialog">
	  <div class="modal-dialog">
        ...
        <div class="modal-body" id="modal-bodyLinks">
	        <c:if test="${requestScope.userVorhanden || requestScope.passwortUngleich }">
				 <script type="text/javascript">
				    $(window).load(function(){
	        	...
	        	<div class="alert alert-danger">
	  				<strong>Fehler!</strong>Dieser Username ist bereits vergeben.
				</div> 
				</c:if>
				<c:if test="${requestScope.passwortUngleich }">
	        	<div class="alert alert-danger">
	  				<strong>Fehler!</strong> Die Passwörter sind nicht gleich!
				</div> 
				</c:if>
			</c:if>
